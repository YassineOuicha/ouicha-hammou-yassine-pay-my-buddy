SHOW DATABASES;
CREATE DATABASE IF NOT EXISTS pay_my_buddy_test_tests;

USE pay_my_buddy_test_tests;
CREATE TABLE user (
...
('TestUser', 'test@example.com', '$2a$10$7sE6cLz2JH6jYwp6DbQfHuHgM.KZ1fuYY4d7OP6a.Blo2E5O/lXma', 1000.00),
('Yassine', 'yassine@example.com', '$2b$12$4E0GRft3b/xQhgohDyOTtuz8zaxGGkhCYX8XQ1YzAzde.TTZPm.pO', 1000.00);
...
(1, 2, 'Shared lunch', 1500.00),
(2, 5, 'Netflix subscription', 850.00),
(3, 7, 'Group purchase', 2000.00),
(4, 9, 'Carpool gas', 250.50),
(5, 1, 'Coffee reimbursement', 545.00),
(6, 7, 'Airbnb reservation', 5000.00),
(7, 9, 'Concert tickets', 300.00),
(8, 2, 'Pizza night', 120.00),
(9, 4, 'Electric scooter rental', 900.50),
(10, 6, 'Weekend trip contribution', 400.00);
